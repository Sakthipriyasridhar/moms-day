# 💖 Streamlit Mother’s Day Card Deployment Guide
...
Copy EVERYTHING below into `app.py`
...
<div class="book">
  ...
  <div class="page" style="z-index:7;">
    <img src="cover.jpg" class="full-img">
...
```text
https://mothersdaycard.streamlit.app
```
...
* open on phone
* share with amma
* post on Instagram bio
* use like real website ✨
